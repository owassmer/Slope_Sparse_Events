...
| `inventory_coverage` | Host, per section, on every inventory item the agent marks covered, duplicate or not decision-relevant | `coverage_supported`, `adds_matter`, `decision_relevance` (Choice) |
