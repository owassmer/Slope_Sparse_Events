...
# Federal Reserve bank holidays, 2024-2026 (a Saturday holiday is not moved to Friday; the Fed stays
# open). This is the business-day convention used
...
BANK_HOLIDAYS = frozenset(date.fromisoformat(d) for d in (
    ...
    "2026-01-01", "2026-01-19", "2026-02-16", "2026-05-25", "2026-06-19", "2026-09-07",
